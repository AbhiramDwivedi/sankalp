...
// ---------------------------------------------------------------------------
// Note: Hindi-specific grammar diagrams (NeConstructionDiagram,
// GenderAgreementDiagram) live with the fcps-stamp-hindi curriculum at
// content/curricula/fcps-stamp-hindi/diagrams.tsx. A different Indian-language
// curriculum would author its own analogous diagrams there.
// ---------------------------------------------------------------------------
